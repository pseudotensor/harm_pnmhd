...
#define INPUTN1 512 // TOTAL SIZE for MPI or not
#define INPUTN2 512
...
//MARK
// grid size PER CPU
#define N1 16 // must be even for totally general consistency
#define N2 32 // must be even for totally general consistency
#define N3 32 // should be 1 if COMPDIM==2, should be even if periodicx2special
...
#define ROTATINGFORCE 1 // rotating force (see averywind())

// whether to have an accretor on the grid (like for averywind())
#define DO_ACCRETOR 1
...
// MARK
#if(COORD==3)
#define GRAVACC              1 // choice : 1->use analytic acceleration(see step.c and init.c) (must setup in analsol.c)
#else
#define GRAVACC              1 // choice -- user setup
#endif
